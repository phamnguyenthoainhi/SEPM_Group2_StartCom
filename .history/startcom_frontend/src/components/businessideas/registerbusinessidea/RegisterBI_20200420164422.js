...
<br/>
                            ...
                            <Grid container spacing={0} className={classes.grid}>
                                ...
                                <FormControl className={classes.formControl}>
                                    ...
                                    <MenuItem value = 'te'>Art</MenuItem>
                                    <MenuItem value = 'technology'>Community</MenuItem>
                                    <MenuItem value = 'technology'>Food & Beverage</MenuItem>
                                    <MenuItem value = 'technology'>Education</MenuItem>
                                    <MenuItem value = 'technology'>Medical</MenuItem>
                                    <MenuItem value = 'technology'>Transportation</MenuItem>
                                    </Select>
                                </FormControl>
